      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-8 p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-3xl font-bold text-[#4b1714]">
                Admin Dashboard
              </h1>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-[#4b1714] to-[#8f0900] px-6 py-4">
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Applicant Name</span>
                        </div>
                        <div className="font-bold text-gray-900 text-lg mb-3">
                          {app.firstApplicantName || 'N/A'}
                        </div>
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            <svg className="w-4 h-4 text-[#e0b674]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1.5">
                              <svg className="w-4 h-4 text-[#4b1714]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex gap-2 pt-4 border-t border-gray-100">
                      <button
                        ...
                        className="flex-1 px-4 py-2.5 bg-[#e0b674] text-sm font-semibold rounded-lg hover:bg-[#4b1714] hover:text-white transition-colors duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
